...
mod tests {
    ...
    fn test_ring_mod_sine_carrier() {
        ...
        for _ in 0..441 { // One period at 100 Hz carrier
    ...
    fn test_ring_mod_square_wave_carrier() {
        ...
        let unique_values: std::collections::HashSet<_> = outputs.iter()
