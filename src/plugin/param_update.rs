...
pub mod param_apply {
    ...
    pub fn apply_param(params: &mut SynthParams, param_id: ParamId, normalized: f32) {
        ...
        match param_id {
            ...
            PARAM_OSC1_UNISON => params.oscillators[0].unison = (denorm as usize).clamp(1, 7),
            ...
            PARAM_OSC2_UNISON => params.oscillators[1].unison = (denorm as usize).clamp(1, 7),
            ...
            PARAM_OSC3_UNISON => params.oscillators[2].unison = (denorm as usize).clamp(1, 7),
