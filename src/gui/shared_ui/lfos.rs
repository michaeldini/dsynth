...
use crate::gui::widgets::param_cycle_button::param_cycle_button;
    ...
    fn get_params(&self, index: usize) -> Self::Params {
        match index {
            1 => LfoParams {
                ...
                destination: PARAM_LFO1_DESTINATION,
            },
            2 => LfoParams {
                ...
                destination: PARAM_LFO2_DESTINATION,
            },
            _ => LfoParams {
                ...
                destination: PARAM_LFO3_DESTINATION,
            },
        }
    }
        ...
        VStack::new(cx, move |cx| {
            ...
            Self::build_param_row(cx, move |cx| {
                ...
                param_knob(
                    ...
                    "Filter",
                    filter_amount_v,
                    default_normalized(p.filter_amount),
                );
            });
            ...
            Self::build_param_row(cx, move |cx| {
                ...
                param_knob(
                    ...
                    "Pitch",
                    pitch_amount_v,
                    default_normalized(p.pitch_amount),
                );
                param_knob(
                    cx,
                    p.gain_amount,
                    "Gain",
                    gain_amount_v,
                    default_normalized(p.gain_amount),
                );
                param_knob(
                    cx,
                    p.pan_amount,
                    "Pan",
                    pan_amount_v,
                    default_normalized(p.pan_amount),
                );
                param_knob(
                    cx,
                    p.pwm_amount,
                    "PWM",
                    pwm_amount_v,
                    default_normalized(p.pwm_amount),
                );
            });
        })
        .height(Pixels(350.0))
